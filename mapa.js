...
function closeNewCard() { el.nc.classList.remove('show'); }
...
function addCardNode(card) {
  ...
  var n = {
    ...
    x: Math.round((cx - NODE_W / 2) / GRID) * GRID,
...
document.getElementById('btn-card').addEventListener('click', openNewCard);
